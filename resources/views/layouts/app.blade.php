  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="{{ url('/index') }}" class="logo">
        ...
        <span class="logo-mini"><b>AT</b>OM</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Atom</b>WEB</span>
      </a>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="#" class="btn btn-default btn-flat">Perfil</a> <!-- Criar nessa linha a rota para o perfil do usuário -->
                  </div>
